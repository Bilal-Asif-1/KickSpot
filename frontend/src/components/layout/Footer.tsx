        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=Boots" className="text-gray-400 hover:text-white transition-colors">
                  Boots
                </Link>
              </li>
              <li>
                <Link to="/products?category=Casual" className="text-gray-400 hover:text-white transition-colors">
                  Casual Shoes
                </Link>
              </li>
            </ul>
